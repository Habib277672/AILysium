        ...
        <div>
            ...
            <section className="mx-auto max-w-6xl px-6 py-16">
                ...
                <div className="mt-10 grid gap-8 md:grid-cols-[1fr_1.4fr]">
                    {/* WhatsApp card */}
                    <div className="self-start overflow-hidden rounded-3xl border border-slate/10 bg-cloud shadow-sm transition-all duration-300 hover:shadow-lg hover:shadow-sky/8">
