  ...
  return (
    <section className="relative overflow-hidden bg-cloud py-16 md:py-28">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col items-center gap-3 px-6 text-center sm:gap-5">
        <h2 className="font-heading text-2xl font-bold leading-snug text-ink sm:text-3xl md:text-[2.75rem] md:leading-tight">
          {heading}
        </h2>
        ...
        <div className="flex w-full flex-wrap items-center justify-center gap-2.5 sm:gap-4">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-sky px-4 py-2.5 text-xs font-semibold text-white shadow-lg shadow-sky/25 transition-all duration-200 hover:bg-sky-light hover:shadow-sky/40 sm:px-8 sm:py-4 sm:text-base"
          >
            {primaryCta.text}
          </a>
          <Link
            to={secondaryCta.to}
            className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-sky/30 px-4 py-2.5 text-xs font-semibold text-sky transition-all duration-200 hover:border-sky hover:bg-sky/5 sm:px-8 sm:py-4 sm:text-base"
          >
            {secondaryCta.text}
          </Link>
        </div>
